...
# see more details: https://github.com/RapidAI/LabelConvert
# documentation: https://rapidai.github.io/LabelConvert/docs/supportconversions/
    ...
    def gen_dataset(self, img_paths, target_img_path, target_json, mode):
        ...
        for img_id, img_path in enumerate(tqdm(img_paths, desc=mode), 1):
            ...
            if Path(label_path).exists():
                new_anno = self.read_annotation(
                    label_path, img_id, height, width)
                if len(new_anno) > 0:
